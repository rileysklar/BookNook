-- Enhanced BookNook schema (without address field)
...
-- Insert sample Austin libraries with simple descriptions
...
-- Success message
SELECT 'Enhanced schema created! 5 Austin libraries with descriptions and coordinates ready for your map!' as message;
